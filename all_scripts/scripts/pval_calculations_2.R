...
#read in AS_TPM by chr
AS_TPM_byarm <- readRDS(file=sprintf("%s/aggregated_results/AS-TPM.inv_var.byarm.rds", dirpath))
...
#save pvals for each state
saveRDS(AS_TPM_bychr_mono_pvals_chr_spec, file = sprintf("%s/aggregated_results/pval_AS_TPM_bychr_mono_pvals_chr_spec.rds", dirpath))
saveRDS(AS_TPM_bychr_ctrl_pvals_chr_spec, file = sprintf("%s/aggregated_results/pval_AS_TPM_bychr_ctrl_pvals_chr_spec.rds", dirpath))
...
saveRDS(AS_TPM_byarm_ctrl_pvals_arm_spec, file = sprintf("%s/aggregated_results/AS_TPM_pval_matrix_control_byarm_armspec.rds", dirpath))
