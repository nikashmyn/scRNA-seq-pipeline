...
plot_raw_data_and_prediction_boxplots_nolog_meddiv <- function(myid = "170512_B4", chr = "chr5", th = 10, 
  ...
  size_bin <- 10
  bns = unlist(lapply(1:floor(nrow(mlt[seqnames==chr])/size_bin+0.5), rep, size_bin))[1:nrow(mlt[seqnames==chr])]
